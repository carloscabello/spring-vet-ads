...
public class DeleteAnimalUITest {
	...
	@Test
	public void testDeleteAnimalUI() throws Exception {
		...
		this.driver.findElement(By.xpath("//input[@value='Animales archivados']")).click();
		this.driver.findElement(By.id("eliminarAnimal")).click();
	}
