...
public class ArchivarLoteUITest {
	...
	@Test
	public void testArchivarLoteUI() throws Exception {
		...
		this.driver.findElement(By.linkText("L019273862")).click();
		this.driver.findElement(By.xpath("//input[@value='Archivar lote completo']")).click();
		...
		this.driver.findElement(By.id("masInfo")).sendKeys("Muerte de mis pequeños");
		this.driver.findElement(By.id("add-animalHistorico-form")).submit();
	}

	@Test
	public void testArchivarLoteNegativoUI() throws Exception {
		this.driver.get("http://localhost:" + this.port);
		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul[2]/li/a")).click();
		this.driver.findElement(By.id("username")).clear();
		this.driver.findElement(By.id("username")).sendKeys("veterinario1");
		...
		this.driver.findElement(By.xpath("//img[@alt='Porcino']")).click();
		this.driver.findElement(By.id("lotesCheck")).click();
		this.driver.findElement(By.linkText("L080972043")).click();
		this.driver.findElement(By.xpath("//input[@value='Archivar lote completo']")).click();
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
	}
