...
public class BorrarProductoUITest {
	...
	@Test
	public void testBorrarProductoUI() throws Exception {
		...
		this.driver.findElement(By.xpath("(//input[@value='Borrar producto'])[2]")).click();
	}
