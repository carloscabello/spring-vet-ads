...
public class ArchivarGanadoUITest {
	...
	@Test
	public void testArchivarGanadoUI() throws Exception {
		...
		this.driver.findElement(By.xpath("//input[@value='Archivar todo el ganado Porcino']")).click();
		...
		this.driver.findElement(By.id("masInfo")).sendKeys("Murieron todos de una enfermedad");
		this.driver.findElement(By.id("add-animalHistorico-form")).submit();
	}

	@Test
	public void testArchivarGanadoNegativoUI() throws Exception {
		this.driver.get("http://localhost:" + this.port);
		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul[2]/li/a")).click();
		this.driver.findElement(By.id("username")).clear();
		this.driver.findElement(By.id("username")).sendKeys("veterinario1");
