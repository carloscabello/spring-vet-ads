...
public class ListCitaUITest {
	...
	public void testListCitasVeterinario() throws Exception {
		...
		ICanWatchTheListCitasBeingVeterinario();
	}
	
	@Test
	public void testListCitasGanadero() throws Exception {
		this.whenLoginAsGanadero().
		ICanWatchTheListCitasBeingGanadero();
	}
	
	public ListCitaUITest whenLoginAsVeterinario() {
	...
	public void ICanWatchTheListCitasBeingVeterinario() {
		this.driver.findElement(By.xpath("//a[contains(@href, '/veterinario/cita/list')]")).click();
	}
	
	public ListCitaUITest whenLoginAsGanadero() {
	...
	public void ICanWatchTheListCitasBeingGanadero() {
